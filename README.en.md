# Hermes CardKit Plugin

[中文](README.md) | [English](README.en.md)
<p align="center">
  <a href="https://github.com/feng84/hermes-cardkit/stargazers"><img alt="GitHub stars" src="https://img.shields.io/github/stars/feng84/hermes-cardkit?style=for-the-badge&logo=github&label=Stars&color=2f80ed"></a>
  <a href="https://github.com/feng84/hermes-cardkit/releases"><img alt="Latest release" src="https://img.shields.io/github/v/release/feng84/hermes-cardkit?style=for-the-badge&logo=githubactions&label=Release&color=22c55e"></a>
  <a href="https://github.com/feng84/hermes-cardkit/actions/workflows/tests.yml"><img alt="Tests" src="https://img.shields.io/github/actions/workflow/status/feng84/hermes-cardkit/tests.yml?branch=main&style=for-the-badge&label=Tests&logo=githubactions"></a>
  ...
  <a href="LICENSE"><img alt="License" src="https://img.shields.io/github/license/feng84/hermes-cardkit?style=for-the-badge&color=64748b"></a>
</p>
...
```bash
curl -fsSL https://raw.githubusercontent.com/feng84/hermes-cardkit/main/install.sh | bash
```

**Windows PowerShell**

```powershell
irm https://raw.githubusercontent.com/feng84/hermes-cardkit/main/install.ps1 | iex
```
...
```bash
export FEISHU_APP_ID=cli_xxx FEISHU_APP_SECRET=xxx HFC_VERSION=v1.0.0
...
See [release history](docs/release-history.en.md) for earlier versions, and [CHANGELOG](CHANGELOG.md) or [GitHub Releases](https://github.com/feng84/hermes-cardkit/releases) for the full record.
...
- V4.6.9: Thanks to [cainiaozp](https://github.com/cainiaozp) for the concurrent-group reproduction and root-cause evidence in [#348](https://github.com/feng84/hermes-cardkit/issues/348) and [mouyong](https://github.com/mouyong) for the compact single-select implementation and tests in [PR #349](https://github.com/feng84/hermes-cardkit/pull/349). The original code author is preserved.

- V4.6.8: Thanks to [coder-zhw](https://github.com/coder-zhw) for the macOS installation, unknown-pidfile and login-startup investigation, implementation and regressions in [PR #347](https://github.com/feng84/hermes-cardkit/pull/347).
- V4.6.6: Thanks to [mouyong](https://github.com/mouyong) for the notice/reading and approval proposals in [PR #338](https://github.com/feng84/hermes-cardkit/pull/338) / [PR #339](https://github.com/feng84/hermes-cardkit/pull/339) and concrete evidence in [#337](https://github.com/feng84/hermes-cardkit/issues/337) / [#340](https://github.com/feng84/hermes-cardkit/issues/340). Adapted with delivery proof, bounded cleanup and preserved defaults; original code authorship remains credited. Thanks also to [tidytorch](https://github.com/tidytorch) for [PR #342](https://github.com/feng84/hermes-cardkit/pull/342): the original authored commit is retained, with a bounded lookup budget and a real lost-response HTTP regression.
- V4.6.4: thanks to [sthnow](https://github.com/sthnow) for cold-start callback and post-interaction ordering evidence in [#335](https://github.com/feng84/hermes-cardkit/issues/335), and patch author **babypanda** for the eager-hook implementation; adapted code retains `Co-authored-by`. Thanks to [mouyong](https://github.com/mouyong) for continuation/notice design and code in [PR #331](https://github.com/feng84/hermes-cardkit/pull/331), and the contributor-preflight request in [#330](https://github.com/feng84/hermes-cardkit/issues/330). Individual parts are adapted; this does not merge the entire PR. Optional reading presets also respond to [jackwude](https://github.com/jackwude)'s [#328](https://github.com/feng84/hermes-cardkit/issues/328) and [leavrcn](https://github.com/leavrcn)'s [#333](https://github.com/feng84/hermes-cardkit/issues/333). All historical credits below are retained.
- V4.6.3: Thanks to [leavrcn](https://github.com/leavrcn) for [#333](https://github.com/feng84/hermes-cardkit/issues/333), reproduction and configuration proposal; adapted tool order/duration/interruption code from [mouyong](https://github.com/mouyong)'s [PR #331](https://github.com/feng84/hermes-cardkit/pull/331), retaining code authorship. Notice retirement and other changes remain separate.
- V4.6.2: Thanks to [jackwude](https://github.com/jackwude) for [#328](https://github.com/feng84/hermes-cardkit/issues/328) and the [#329](https://github.com/feng84/hermes-cardkit/issues/329) evidence for 4.6.1; [mouyong](https://github.com/mouyong) proposed `hide_completed_tool_activity` in [PR #331](https://github.com/feng84/hermes-cardkit/pull/331). Only that configuration feature is adapted here, with an opt-in default and completed/failed coverage; the rest of #331 remains under review.
- V4.6.1: Thanks to [mouyong](https://github.com/mouyong) for [PR #325](https://github.com/feng84/hermes-cardkit/pull/325) and [#326](https://github.com/feng84/hermes-cardkit/issues/326); original commits retained.
- V4.6.0: [mouyong](https://github.com/mouyong) supplied the additional [PR #310](https://github.com/feng84/hermes-cardkit/pull/310) fixes and [#320](https://github.com/feng84/hermes-cardkit/issues/320) evidence; [zhangzq](https://github.com/zhangzq) supplied structured-reasoning diagnostics in [#319](https://github.com/feng84/hermes-cardkit/issues/319); [qqqq560204-maker](https://github.com/qqqq560204-maker) isolated custom-profile recall routing in [#323](https://github.com/feng84/hermes-cardkit/issues/323). Original PR authorship is retained.
- V4.5.1–V4.5.2: [mouyong](https://github.com/mouyong) contributed [PR #310](https://github.com/feng84/hermes-cardkit/pull/310), field reports and retesting for #282, #304, #305, #307, #311–#314 and #318/#321, including the queued-outcome fix and transient notice recall; [lanx214](https://github.com/lanx214) reported [#316](https://github.com/feng84/hermes-cardkit/issues/316) and implemented extracted-clarify compatibility in [PR #317](https://github.com/feng84/hermes-cardkit/pull/317); [qqqq560204-maker](https://github.com/qqqq560204-maker) and [7360403-coder](https://github.com/7360403-coder) supplied the CardKit 300301 evidence in [#306](https://github.com/feng84/hermes-cardkit/issues/306). Original PR authorship is preserved, with maintainer safety corrections and regression coverage. The reporter withdrew #282; this does not establish a mobile fix.
...
### V4.4.3
- [mouyong](https://github.com/mouyong): the multiplex production report in [#268](https://github.com/feng84/hermes-cardkit/issues/268) and the empty-timeline feedback in [#269](https://github.com/feng84/hermes-cardkit/issues/269). The reporter's real multi-bot environment still needs retesting for #268.
### V4.4.2
- [ywarmy](https://github.com/ywarmy): [#261](https://github.com/feng84/hermes-cardkit/issues/261), Hermes 0.21 completion-marker report.
- [Ricadre](https://github.com/Ricadre): [#265](https://github.com/feng84/hermes-cardkit/issues/265), stale integrity migration reproduction.
- [mouyong](https://github.com/mouyong): [#83](https://github.com/feng84/hermes-cardkit/issues/83), [#263](https://github.com/feng84/hermes-cardkit/issues/263), [#264](https://github.com/feng84/hermes-cardkit/issues/264), [#266](https://github.com/feng84/hermes-cardkit/issues/266), Docker/source-only and multiplex evidence; [#258](https://github.com/feng84/hermes-cardkit/issues/258), approval readability feedback.
### V4.4.1
- [liooil](https://github.com/liooil) contributed the Hermes facade-decomposition implementation in [PR #257](https://github.com/feng84/hermes-cardkit/pull/257); [Clarence-G](https://github.com/Clarence-G) contributed topic follow-up, queue/redirect, and cron delivery work in [PR #251](https://github.com/feng84/hermes-cardkit/pull/251). Original code commits and authorship are retained.
- [mouyong](https://github.com/mouyong) supplied multiplex-profile, topic, and readability feedback in [#83](https://github.com/feng84/hermes-cardkit/issues/83), [#252](https://github.com/feng84/hermes-cardkit/issues/252), [#253](https://github.com/feng84/hermes-cardkit/issues/253), [#258](https://github.com/feng84/hermes-cardkit/issues/258), and [#259](https://github.com/feng84/hermes-cardkit/issues/259); [shiboyumm](https://github.com/shiboyumm) opened the original [#83](https://github.com/feng84/hermes-cardkit/issues/83) configuration question; [Boer2333](https://github.com/Boer2333) requested provider attribution in [#250](https://github.com/feng84/hermes-cardkit/issues/250).
- [sp960817](https://github.com/sp960817), [Kevin32623](https://github.com/Kevin32623), and [shichenshuo-star](https://github.com/shichenshuo-star) reported Hermes 0.21 incompatibility in [#254](https://github.com/feng84/hermes-cardkit/issues/254), [#255](https://github.com/feng84/hermes-cardkit/issues/255), and [#256](https://github.com/feng84/hermes-cardkit/issues/256); [hnzwx](https://github.com/hnzwx) and [leavrcn](https://github.com/leavrcn) supplied additional reproduction and compatibility evidence in [#254](https://github.com/feng84/hermes-cardkit/issues/254). [micah928](https://github.com/micah928) supplied historical no-card evidence in [#73](https://github.com/feng84/hermes-cardkit/issues/73), whose current environment still needs retesting.
- Dependabot supplied the CodeQL updates in [PR #247](https://github.com/feng84/hermes-cardkit/pull/247) and [PR #248](https://github.com/feng84/hermes-cardkit/pull/248).
- Restored historical acknowledgements: [lanx214](https://github.com/lanx214) supplied the Linux reproduction in [Issue #240](https://github.com/feng84/hermes-cardkit/issues/240) ([V4.3.7](https://github.com/feng84/hermes-cardkit/releases/tag/v4.3.7)); [Lite-G](https://github.com/Lite-G) reported, reproduced, tested, and implemented the Feishu edit-fallback fix in [PR #235](https://github.com/feng84/hermes-cardkit/pull/235) ([V4.3.5](https://github.com/feng84/hermes-cardkit/releases/tag/v4.3.5)); [lyp88997](https://github.com/lyp88997) supplied the toast-only `200673` fix direction and observations of updates across environments ([V4.3.2](https://github.com/feng84/hermes-cardkit/releases/tag/v4.3.2)). These contributions belong to earlier releases; this cycle restores their missing historical attribution.

This list preserves code, PR proposals, issue reproductions, and real-environment retesting. GitHub's [Contributors](https://github.com/feng84/hermes-cardkit/graphs/contributors) graph is commit-based; people who contributed only issue reports, comments, logs, or acceptance evidence may not appear in that graph and are still credited here.

- [gischuck](https://github.com/gischuck) - [PR #12](https://github.com/feng84/hermes-cardkit/pull/12) Accept-Encoding fix; [PR #76](https://github.com/feng84/hermes-cardkit/pull/76) reasoning/tool timeline UX proposal and implementation exploration
- [fengs2021](https://github.com/fengs2021) - [PR #17](https://github.com/feng84/hermes-cardkit/pull/17) lock optimization and update interval improvement
- [colinaaa](https://github.com/colinaaa) - [PR #87](https://github.com/feng84/hermes-cardkit/pull/87) WebSocket `interaction.select` clarify/approval card interaction support; [PR #88](https://github.com/feng84/hermes-cardkit/pull/88) fresh cards for second turns when Feishu topic groups reuse `message_id`; [PR #91](https://github.com/feng84/hermes-cardkit/pull/91) cron `thread_id` routing back to the originating Feishu topic-group thread
- [zayn-0101](https://github.com/zayn-0101) - [PR #77](https://github.com/feng84/hermes-cardkit/pull/77) cron `deliver=origin/all` routing-intent card delivery fix; [PR #196](https://github.com/feng84/hermes-cardkit/pull/196) non-blocking slash confirmation; [Cassius0924](https://github.com/Cassius0924) - [PR #199](https://github.com/feng84/hermes-cardkit/pull/199) multi-select and custom-answer forms
- [Zanetach](https://github.com/Zanetach) - [PR #84](https://github.com/feng84/hermes-cardkit/pull/84) / @Zanetach: card progress-status routing and `.env` allowlist expansion for profile environment support (V3.9.0)
- [colinaaa](https://github.com/colinaaa) - [PR #93](https://github.com/feng84/hermes-cardkit/pull/93) reliable terminal cards for interrupted tasks; [PR #97](https://github.com/feng84/hermes-cardkit/pull/97) completed-answer preservation (V3.9.1)
- [wjiemin49-ux](https://github.com/wjiemin49-ux) - [PR #52](https://github.com/feng84/hermes-cardkit/pull/52) diagnosis and direction for loopback health checks bypassing proxies (adopted in V3.9.1)
- [colinaaa](https://github.com/colinaaa) - [Issue #94](https://github.com/feng84/hermes-cardkit/issues/94) requirements, interaction flow, and security boundary for the native bare `/resume` picker (V3.10.0)
- [charles5g](https://github.com/charles5g) / jackmim - [PR #98](https://github.com/feng84/hermes-cardkit/pull/98) asynchronous model-picker callbacks, original-card status updates, and semantic model-footer color concept; mainline adds HTML escaping and preserves layout (V3.9.1–V3.10.0)
- [tianqiii](https://github.com/tianqiii) - [Issue #107](https://github.com/feng84/hermes-cardkit/issues/107) requirements, Hermes-native API direction, and display format for the Codex subscription-quota footer (V4.0.2)
- [sthnow](https://github.com/sthnow) - [Issue #110](https://github.com/feng84/hermes-cardkit/issues/110) reproduction, root-cause analysis, and expected boundary for literal `MEDIA:` text inside Markdown code (V4.0.4)
- [zkyken](https://github.com/zkyken) - [Issue #112](https://github.com/feng84/hermes-cardkit/issues/112) logs, bound-callback diagnosis, and fix direction for non-functional lark SDK interaction buttons (V4.0.4)
- [ShakuOvO](https://github.com/ShakuOvO) / [blakejia](https://github.com/blakejia) - [Issue #106](https://github.com/feng84/hermes-cardkit/issues/106) and [#111](https://github.com/feng84/hermes-cardkit/issues/111) reports, retesting, and screenshots for duplicate gray image-answer text (V4.0.1-V4.0.3); additional thanks to [blakejia](https://github.com/blakejia) for [#115](https://github.com/feng84/hermes-cardkit/issues/115) runtime-version evidence, complete upgrade steps, and metrics (V4.0.5); thanks to [nasvip](https://github.com/nasvip), [hzy](https://github.com/hzy), and [lRoccoon](https://github.com/lRoccoon) for V4.0.6's Hermes-upgrade reproduction, background notice-card implementation, and production completion-hook diagnosis/fix; V4.0.7 additionally credits [nasvip](https://github.com/nasvip) for [Issue #125](https://github.com/feng84/hermes-cardkit/issues/125)'s complete systemd/Python-environment evidence and [hzy](https://github.com/hzy) for [PR #124](https://github.com/feng84/hermes-cardkit/pull/124)'s self-improvement notice implementation and regression coverage; V4.0.8 thanks [zyq2552899783-lgtm](https://github.com/zyq2552899783-lgtm) for reporting [Issue #127](https://github.com/feng84/hermes-cardkit/issues/127), where cron delivery showed only the attachment filename; V4.0.9 thanks [Jasonsun77](https://github.com/Jasonsun77) for [Issue #130](https://github.com/feng84/hermes-cardkit/issues/130)'s Linux crash-loop A/B, complete timing, SDK versions, and upstream reconnect evidence
