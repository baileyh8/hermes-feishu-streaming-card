...
当前发布候选为 `4.5.2`。本轮修复排队任务失败结果与临时提示撤回（#318/#321）；#319/#320 仍待运行证据，不宣称生产升级或手机真机验收完成。

本轮为 CardKit 短 ID、话题路由与审批生命周期修复；真实未发送实体已验证。完整回归、精确合并提交 CI 和公开安装验证完成前不得发版；移动端现场验收仍开放。
