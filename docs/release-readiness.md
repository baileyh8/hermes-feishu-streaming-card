...
- 真实飞书私聊：`/hfc doctor`、中文详情、recheck、后台 successor 再次点击、同卡 PATCH、sandbox 两步安全修复、重启确认/取消、普通 footer snapshot。**已通过（2026-07-11）**。
- 真实飞书剩余项：卡片实际执行 Gateway 重启、群内发起者与 changed-operator rejection、topic、cron、profile route mismatch。**待验收**。
