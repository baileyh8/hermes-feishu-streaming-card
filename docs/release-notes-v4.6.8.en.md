# V4.6.8: CardKit restart recovery and 230011 failure-loop fix
...
- Version markers (`pyproject.toml`, `config.yaml.example`, `docker-compose.example.yml`, CI workflow, docs) aligned to 4.6.8.
